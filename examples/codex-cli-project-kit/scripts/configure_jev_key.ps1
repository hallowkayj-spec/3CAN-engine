...
$credentialPath = Join-Path $credentialDirectory 'runtimehook-vercel.clixml'
...
$key = Read-Host 'Paste Vercel AI Gateway key (hidden; never send it in chat)' -AsSecureString
